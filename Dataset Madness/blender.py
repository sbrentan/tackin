...
def loadWorlds():
    ...
    bpy.context.scene.world.node_tree.links.new(enode.outputs["Color"],bpy.context.scene.world.node_tree.nodes["World Output"].inputs["Surface"])
    ...
    #with open(cocoYaml,'w',encoding='utf-8') as fc:
        ...
        for i in range(100):
            ...
            if principled_bsdf is not None:
                principled_bsdf.inputs[0].default_value = (random.randint(0,1000)/1000,random.randint(0,1000)/1000,random.randint(0,1000)/1000, 1)
