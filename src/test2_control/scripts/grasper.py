...
def init():
    ...
    global attach_srv, detach_srv, mstate_srv, last_updated_image, bridge, set_state_srv, spawn_model, delete_model
    ...
    rospy.loginfo("Created ServiceProxy to /gazebo/spawn_sdf_model")

    rospy.wait_for_service("gazebo/delete_model")
    delete_model = rospy.ServiceProxy("gazebo/delete_model", DeleteModel)
    rospy.loginfo("Created ServiceProxy to /gazebo/delete_model")
