...
public:
  ...
  RobotArm() 
  {
    ...
    traj_client_ = new TrajClient("trajectory_msgs/JointTrajectory", true);
  ...
  */
  pr2_controllers_msgs::JointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.joint_names.push_back("f_joint1");
    goal.trajectory.joint_names.push_back("f_joint2");
